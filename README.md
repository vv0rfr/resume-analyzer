...
### 岗位推荐结果
AI 根据简历内容自动匹配岗位，0-100 打分，标注匹配/缺失技能，知识库未覆盖方向由 AI 自主推荐并标注「AI推荐」标签。

![岗位推荐结果](./screenshots/screenshots1.png)

### 深度分析（上）— 核心优势与能力短板
从简历中提取具体证据，逐条分析优势点；诚实指出能力短板，按严重程度分级（高/中/低）。

![深度分析-优势与短板](./screenshots/screenshots2.png)

### 深度分析（下）— 关键词匹配、STAR 评估与综合评价
技术关键词级别的逐项匹配，STAR 法则视角评估经历质量，猎头推荐语风格的综合评价。

![深度分析-关键词与评估](./screenshots/screenshots3.png)

### 优化建议（上）— 改写建议与补充项
逐条改写前后对比（原文 → 优化），说明改写原因和放置位置；建议简历中补充的具体内容和示例写法。

![优化建议-改写与补充](./screenshots/screenshots4.png)

### 优化建议（下）— 结构建议、面试准备与关键词优化
简历整体结构调整建议，基于简历薄弱点预测面试问题并给出回答方向，关键词优化以通过 ATS 筛选。

![优化建议-面试与关键词](./screenshots/screenshots5.png)
